...
const SignupSide = styled(Box)(({ theme }) => ({
  background: '#FFF',
  backdropFilter: 'blur(10px)',
  padding: '40px',
  display: 'flex',
...
export default function SignupPage() {
  ...
  return (
    <>
      <Head>
        <title>Sign Up - Social Stratix</title>
      </Head>
      <SignupContainer>
        <MainCard>
          <TestimonialSide>
          ...
          <SignupSide>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: '32px', width: '100%', maxWidth: '442px' }}>
              ...
              <GoogleButton variant="outlined" startIcon={
                <Box
                  component="img"
                  src="https://api.builder.io/api/v1/image/assets/TEMP/c8976bb189d1363447c5e75791732a66097e48be?width=76"
                  alt="Google"
